    ...
    <div className='w-full py-8'>
        ...
        <div className='space-y-4 container mx-auto flex-col flex justify-center items-center'>
                        ...
                        <div className='flex justify-center items-center gap-56 border-2 p-6 rounded-3xl'>
                            <div className='flex justify-center gap-4 items-center'>
                                <img className='rounded-3xl w-56 object-cover h-56' src={el.thumbnail} alt="thumbnailimage" />
                                    <div>
                                        <p className='font-semibold text-[22px]'>{el.title}</p>
                            ...
                            <div>
                                <p className=' text-[18px]'>Total: <span className='font-semibold'>${el.price * el.cartQuantity}</span></p>
                            </div>
            ...
            <div className='flex  items-start justify-between gap-[900px]'>
                <button className='text-[gray] text-[20px] border-2 py-2 px-4 rounded-lg'>Clear cart</button>
                <div className='space-y-2 flex flex-col'>
                    
                    <p className='text-[18px]'>Subtotal: <span className='font-semibold'>${cart.cartTotalAmount}</span></p>
